  ...
  return (
    ...
    before:inline-block before:size-6 before:bg-white checked:before:bg-white before:translate-x-0 checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-white"
                ...
                <div className="mt-6 md:mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center">
                  ...
                  <div className="flex flex-col bg-white border-2 border-violet-900 text-center shadow-xl rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-violet-700">
                    ...
                    <CustomLink
                      ...
                      url="https://github.com/htmlstreamofficial/preline/tree/main/examples/html"
                    >
                      Get started
                    </CustomLink>
                  </div>
                ...
                <div className="flex justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
                  <svg
                    className="size-16 md:size-20 lg:size-24 mx-auto sm:mx-0 text-gray-500 dark:text-neutral-500"
          ...
          {/* End Testimonials */}
          {/* FAQ */}
          <div className="max-w-[85rem] px-4 py-10 pb-48 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            {/* Grid */}
