...
function Contact() {
  return (
    <>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl lg:max-w-5xl mx-auto">
          ...
          <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
            {/* Card */}
            <div className="z-50 flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-neutral-700">
      ...
      <div className="grid space-x-0 space-y-6 pt-20 pb-48 md:grid-cols-3 md:gap-3 md:justify-items-center">
        {/* Item */}
        ...
        <div className="flex gap-x-5">
          ...
          <div className="grow">
            ...
            <p className="mt-1 text-neutral-400 text-balance">
              +254 712 345 678
            </p>
          </div>
        </div>
