...
function Login() {
  return (
    <>
      {/* Hero */}
      <div className="relative flex justify-center items-center min-h-svh bg-gradient-to-bl from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
