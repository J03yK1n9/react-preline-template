          ...
          Resume
            ...
            <div className="hs-dropdown relative inline-flex">
              <button
                id="hs-dropdown-default"
                type="button"
                className="hs-dropdown-toggle py-3 px-4 inline-flex items-center gap-x-2 z-40 text-sm font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-neutral-400 dark:hover:text-white disabled:opacity-50 disabled:pointer-events-none  dark:border-neutral-700 focus:text-blue-600 focus:dark:text-blue-500"
              >
                {/* Resources
    <svg
      className="hs-dropdown-open:rotate-180 size-4"
  ...
  > */}
              ...
              <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden text-balance z-10 top-full start-0 min-w-60 bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-neutral-800 dark:divide-neutral-700 before:absolute before:-top-5 before:start-0 before:w-full before:h-5">
                <div className="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="hidden md:flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
            ...
            {links.map((link) => {
              return (
                <div key={link.to}>
                  <CustomLink
                    className="px-4 inline-flex items-center gap-x-2 font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-neutral-400 dark:hover:text-neutral-500"
                    url={link.to}
                  >
                    {link.name}
                  </CustomLink>
        ...
        >
          Pricing
            ...
            <div className="flex items-center gap-x-2 pl-4 sm:pl-0 sm:ms-auto">
              <CustomLink
                className="flex items-center gap-x-2 pr-10 font-medium text-gray-500 hover:text-blue-600 dark:text-neutral-400 dark:hover:text-blue-500"
                url="/login"
              >
                <svg
